// === STORAGE KEY KHUSUS CUCI TANGAN ===
const STORAGE_CUCI = {
  PERIODE: "cuci_dataPeriode",
  RUANGAN: "cuci_dataRuangan"
};
...
========================= */
  ...
  const btnIcon = document.querySelector('.toggle-sidebar i');
...
function simpanPeriode() {
 ...
 let dataPeriode = JSON.parse(localStorage.getItem(STORAGE_CUCI.PERIODE)) || {};
localStorage.setItem(STORAGE_CUCI.PERIODE, JSON.stringify(dataPeriode));
  ...
  localStorage.setItem("cuci_dataPeriode"
, JSON.stringify(dataPeriode));
}
...
function simpanPeriodeKeDataPeriode(bulan, tahun, ruanganBaru) {
  let dataPeriode = JSON.parse(localStorage.getItem("cuci_dataPeriode"
)) || {};
...
function renderTabelPeriode(key) {
  ...
  const dataPeriode = JSON.parse(localStorage.getItem("cuci_dataPeriode"
)) || {};
...
document.addEventListener("click", function (e) {
  ...
  if (btnHapus) {
    ...
    showAlert({
      ...
      autoFocus: "cancel",
      onConfirm: () => {
        let data = JSON.parse(localStorage.getItem("cuci_dataPeriode"
)) || {};
        delete data[key];
        localStorage.setItem("cuci_dataPeriode"
, JSON.stringify(data));
